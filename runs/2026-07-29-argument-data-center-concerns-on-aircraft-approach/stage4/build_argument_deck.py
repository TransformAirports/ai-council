...
set_alt(g4, "Side-by-side comparison: the 2018 Western Lands data-center "
            "sale sat outside the approach surfaces and went through FAA "
            "process; the proposed site sits inside the surfaces with no "
            "FAA coordination and is not on the approved ALP.")
...
notes(s4, "Take the objection at full strength: data centers can work at "
          "IAD — MWAA proved it in 2018. But the Western Lands deal sat "
          "outside the protected surfaces and went through FAA process. The "
          "precedent validates the use and condemns the site. No documented "
          "incident in Loudoun County's roughly 26M sq ft of data centers, "
          "but none of them sit inside an ILS approach corridor; absence of "
          "an accident is not permission.")
